        ...
        <?php if ($chucVu === 'Quản trị viên' || $chucVu === "Nhân viên bán hàng"): ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages"
                     data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="login.html">Chưa phê duyệt</a>
                        <a class="collapse-item" href="register.html">Đã phê duyệt</a>
                        <a class="collapse-item" href="forgot-password.html">Đang giao hàng</a>
                        <a class="collapse-item" href="404.html">Đã thanh toán</a>
                    </div>
                </div>
            </li>
        <?php endif; ?>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Bản quyền thuộc về &copy; MobileShop 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
